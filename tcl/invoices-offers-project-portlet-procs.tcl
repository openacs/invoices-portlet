...
namespace eval invoices_offers_project_portlet {
    ...
    ad_proc -private get_my_name {
        ...
        return "invoices_offers_project_portlet"
    }

    ad_proc -public get_pretty_name {
    } {
        return "#invoices-portlet.invoices_offers_project_portlet#"
    }
    ...
    ad_proc -public show {
	 cf
        ...
        portal::show_proc_helper \
            -package_key [my_package_key] \
            -config_list $cf \
            -template_src "invoices-offers-project-portlet"		
    }
